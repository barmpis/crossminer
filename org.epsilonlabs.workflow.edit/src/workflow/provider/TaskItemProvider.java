	...
	protected void addAcceptsPartialDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_acceptsPartialData_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_acceptsPartialData_feature", "_UI_Task_type"),
				 WorkflowPackage.Literals.TASK__ACCEPTS_PARTIAL_DATA,
				 true,
				 false,
				 false,
