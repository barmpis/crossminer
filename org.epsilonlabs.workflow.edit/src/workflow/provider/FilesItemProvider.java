...
/**
 * This is the item provider adapter for a {@link workflow.Files} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FilesItemProvider extends DataRetrievalItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Files_patterns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Files_patterns_feature", "_UI_Files_type"),
				 WorkflowPackage.Literals.FILES__PATTERNS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Files_type") + " " + files.isAcceptsPartialData();
	}
