...
/**
 * This is the item provider adapter for a {@link workflow.DataFiltering} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataFilteringItemProvider extends DataManipulationItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((DataFiltering)object).getTemp();
		return label == null || label.length() == 0 ?
			getString("_UI_DataFiltering_type") :
