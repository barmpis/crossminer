...
/**
 * This is the item provider adapter for a {@link workflow.String} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringItemProvider extends VariableItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.STRING__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((workflow.String)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(workflow.String.class)) {
			case WorkflowPackage.STRING__VALUE:
