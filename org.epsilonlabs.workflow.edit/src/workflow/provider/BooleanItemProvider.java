...
/**
 * This is the item provider adapter for a {@link workflow.Boolean} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanItemProvider extends VariableItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.BOOLEAN__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((workflow.Boolean)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(workflow.Boolean.class)) {
			case WorkflowPackage.BOOLEAN__VALUE:
