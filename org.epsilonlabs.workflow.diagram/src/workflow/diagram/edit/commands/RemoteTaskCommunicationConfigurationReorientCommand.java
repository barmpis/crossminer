 ...
 * @generated
 */
public class RemoteTaskCommunicationConfigurationReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RemoteTaskCommunicationConfigurationReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof RemoteTaskCommunicationConfiguration) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return WorkflowBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRemoteTaskCommunicationConfiguration_4004(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Workflow container = (Workflow) getLink().eContainer();
		return WorkflowBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRemoteTaskCommunicationConfiguration_4004(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected RemoteTaskCommunicationConfiguration getLink() {
		return (RemoteTaskCommunicationConfiguration) getElementToEdit();
	}
