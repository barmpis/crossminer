 ...
 * @generated
 */
public class GithubBigQueryItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public GithubBigQueryItemSemanticEditPolicy() {
		super(WorkflowElementTypes.GithubBigQuery_2002);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(incomingLink) == DataRetrievalSourcesEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(outgoingLink) == DataSourceRetrievalsEditPart.VISUAL_ID) {
