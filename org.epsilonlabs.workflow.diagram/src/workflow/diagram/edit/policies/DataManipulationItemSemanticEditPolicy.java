 ...
 * @generated
 */
public class DataManipulationItemSemanticEditPolicy extends WorkflowBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public DataManipulationItemSemanticEditPolicy() {
		super(WorkflowElementTypes.DataManipulation_2010);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WorkflowVisualIDRegistry.getVisualID(outgoingLink) == DataManipulationSourcesEditPart.VISUAL_ID) {
