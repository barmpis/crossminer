 ...
 * @generated
 */
public class CommunicationChannelCommunicationChannelTypeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkflowPackage.eINSTANCE.getCommunicationChannel_Type();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getCommunicationChannelCommunicationChannelTypeCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return DataStructure2EditPart.VISUAL_ID == WorkflowVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkflowNodeDescriptor> childDescriptors = WorkflowDiagramUpdater
				.getCommunicationChannelCommunicationChannelTypeCompartment_7002SemanticChildren(
