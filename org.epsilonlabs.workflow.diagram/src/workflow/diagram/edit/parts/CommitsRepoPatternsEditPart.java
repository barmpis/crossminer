 ...
 * @generated
 */
public class CommitsRepoPatternsEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CommitsRepoPatternsEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Commits_2004, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.CommitsRepoPatternsEditPart.VISUAL_ID));
		}
		return parser;
	}
