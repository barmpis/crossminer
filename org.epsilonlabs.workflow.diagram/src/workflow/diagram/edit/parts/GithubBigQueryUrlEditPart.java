 ...
 * @generated
 */
public class GithubBigQueryUrlEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GithubBigQueryUrlEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.GithubBigQuery_2002, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.GithubBigQueryUrlEditPart.VISUAL_ID));
		}
		return parser;
	}
