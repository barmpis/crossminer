 ...
 * @generated
 */
public class DoubleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DoubleNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Double_2015, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.DoubleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
