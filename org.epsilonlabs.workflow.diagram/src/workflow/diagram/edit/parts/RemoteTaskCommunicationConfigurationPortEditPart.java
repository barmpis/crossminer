 ...
 * @generated
 */
public class RemoteTaskCommunicationConfigurationPortEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				WorkflowVisualIDRegistry.getType(
						workflow.diagram.edit.parts.RemoteTaskCommunicationConfigurationPortEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public RemoteTaskCommunicationConfigurationPortEditPart(View view) {
		super(view);
	}
