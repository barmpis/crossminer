 ...
 * @generated
 */
public class TaskImplementationEntryPoinEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TaskImplementationEntryPoinEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Task_2016, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.TaskImplementationEntryPoinEditPart.VISUAL_ID));
		}
		return parser;
	}
