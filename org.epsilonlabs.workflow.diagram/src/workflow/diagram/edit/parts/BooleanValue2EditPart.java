 ...
 * @generated
 */
public class BooleanValue2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BooleanValue2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Boolean_3003, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.BooleanValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
