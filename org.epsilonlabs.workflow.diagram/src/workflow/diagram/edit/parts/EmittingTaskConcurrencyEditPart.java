 ...
 * @generated
 */
public class EmittingTaskConcurrencyEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmittingTaskConcurrencyEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.EmittingTask_2011, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.EmittingTaskConcurrencyEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, WorkflowEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
