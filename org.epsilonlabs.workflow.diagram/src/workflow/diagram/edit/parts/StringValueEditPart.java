 ...
 * @generated
 */
public class StringValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StringValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.String_2012, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.StringValueEditPart.VISUAL_ID));
		}
		return parser;
	}
