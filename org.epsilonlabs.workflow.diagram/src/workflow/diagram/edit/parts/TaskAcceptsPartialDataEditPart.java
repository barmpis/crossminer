 ...
 * @generated
 */
public class TaskAcceptsPartialDataEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TaskAcceptsPartialDataEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Task_2016, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.TaskAcceptsPartialDataEditPart.VISUAL_ID));
		}
		return parser;
	}
