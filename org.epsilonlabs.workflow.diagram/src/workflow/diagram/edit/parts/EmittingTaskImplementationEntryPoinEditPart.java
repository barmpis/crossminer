 ...
 * @generated
 */
public class EmittingTaskImplementationEntryPoinEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmittingTaskImplementationEntryPoinEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.EmittingTask_2011, getParserElement(),
					WorkflowVisualIDRegistry.getType(
							workflow.diagram.edit.parts.EmittingTaskImplementationEntryPoinEditPart.VISUAL_ID));
		}
		return parser;
	}
