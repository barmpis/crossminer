 ...
 * @generated
 */
public class DoubleName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DoubleName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Double_3004, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.DoubleName2EditPart.VISUAL_ID));
		}
		return parser;
	}
