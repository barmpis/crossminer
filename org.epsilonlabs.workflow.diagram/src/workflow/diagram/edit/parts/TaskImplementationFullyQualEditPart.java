 ...
 * @generated
 */
public class TaskImplementationFullyQualEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TaskImplementationFullyQualEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Task_2016, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.TaskImplementationFullyQualEditPart.VISUAL_ID));
		}
		return parser;
	}
