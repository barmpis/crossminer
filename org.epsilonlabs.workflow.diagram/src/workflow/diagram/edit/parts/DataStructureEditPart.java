...
import workflow.diagram.edit.policies.DataStructureItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DataStructureEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DataStructureEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataStructureItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataStructureNameEditPart) {
			((DataStructureNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureDataStructureLabelFigure());
			return true;
		}
		if (childEditPart instanceof DataStructureDataStructureTypeCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getDataStructureTypeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((DataStructureDataStructureTypeCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DataStructureDataStructureTypeCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getDataStructureTypeCompartmentFigure();
			pane.remove(((DataStructureDataStructureTypeCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof DataStructureDataStructureTypeCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WorkflowVisualIDRegistry.getType(DataStructureNameEditPart.VISUAL_ID));
	}
