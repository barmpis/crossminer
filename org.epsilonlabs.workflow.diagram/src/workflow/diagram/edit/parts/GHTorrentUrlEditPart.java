 ...
 * @generated
 */
public class GHTorrentUrlEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GHTorrentUrlEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.GHTorrent_2003, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.GHTorrentUrlEditPart.VISUAL_ID));
		}
		return parser;
	}
