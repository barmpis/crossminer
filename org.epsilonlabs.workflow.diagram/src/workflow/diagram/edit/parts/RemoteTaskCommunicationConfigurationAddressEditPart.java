 ...
 * @generated
 */
public class RemoteTaskCommunicationConfigurationAddressEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				WorkflowVisualIDRegistry.getType(
						workflow.diagram.edit.parts.RemoteTaskCommunicationConfigurationAddressEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public RemoteTaskCommunicationConfigurationAddressEditPart(View view) {
		super(view);
	}
