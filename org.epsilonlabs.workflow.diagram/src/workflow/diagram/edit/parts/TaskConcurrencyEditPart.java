 ...
 * @generated
 */
public class TaskConcurrencyEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TaskConcurrencyEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Task_2016, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.TaskConcurrencyEditPart.VISUAL_ID));
		}
		return parser;
	}
