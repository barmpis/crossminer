 ...
 * @generated
 */
public class BooleanNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BooleanNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Boolean_2014, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.BooleanNameEditPart.VISUAL_ID));
		}
		return parser;
	}
