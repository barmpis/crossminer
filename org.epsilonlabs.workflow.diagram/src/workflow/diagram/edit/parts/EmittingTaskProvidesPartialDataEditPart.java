 ...
 * @generated
 */
public class EmittingTaskProvidesPartialDataEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmittingTaskProvidesPartialDataEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.EmittingTask_2011, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.EmittingTaskProvidesPartialDataEditPart.VISUAL_ID));
		}
		return parser;
	}
