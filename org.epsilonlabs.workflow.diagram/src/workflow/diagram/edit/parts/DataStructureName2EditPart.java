 ...
 * @generated
 */
public class DataStructureName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataStructureName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.DataStructure_3001, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.DataStructureName2EditPart.VISUAL_ID));
		}
		return parser;
	}
