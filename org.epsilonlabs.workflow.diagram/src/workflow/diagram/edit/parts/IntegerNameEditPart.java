 ...
 * @generated
 */
public class IntegerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IntegerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Integer_2013, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.IntegerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
