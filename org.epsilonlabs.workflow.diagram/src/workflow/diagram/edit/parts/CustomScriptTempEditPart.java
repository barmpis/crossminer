 ...
 * @generated
 */
public class CustomScriptTempEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CustomScriptTempEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.CustomScript_2009, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.CustomScriptTempEditPart.VISUAL_ID));
		}
		return parser;
	}
