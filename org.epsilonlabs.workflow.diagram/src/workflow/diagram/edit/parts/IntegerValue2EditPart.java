 ...
 * @generated
 */
public class IntegerValue2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IntegerValue2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Integer_3002, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.IntegerValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
