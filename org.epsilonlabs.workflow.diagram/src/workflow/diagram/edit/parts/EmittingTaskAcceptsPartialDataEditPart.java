 ...
 * @generated
 */
public class EmittingTaskAcceptsPartialDataEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmittingTaskAcceptsPartialDataEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.EmittingTask_2011, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.EmittingTaskAcceptsPartialDataEditPart.VISUAL_ID));
		}
		return parser;
	}
