 ...
 * @generated
 */
public class DataStructureNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataStructureNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.DataStructure_2019, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.DataStructureNameEditPart.VISUAL_ID));
		}
		return parser;
	}
