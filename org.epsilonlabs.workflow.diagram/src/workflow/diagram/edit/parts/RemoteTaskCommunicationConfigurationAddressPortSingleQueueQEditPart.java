 ...
 * @generated
 */
public class RemoteTaskCommunicationConfigurationAddressPortSingleQueueQEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(
				WorkflowVisualIDRegistry.getType(
						workflow.diagram.edit.parts.RemoteTaskCommunicationConfigurationAddressPortSingleQueueQEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public RemoteTaskCommunicationConfigurationAddressPortSingleQueueQEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.RemoteTaskCommunicationConfiguration_4004,
					getParserElement(), WorkflowVisualIDRegistry.getType(
							workflow.diagram.edit.parts.RemoteTaskCommunicationConfigurationAddressPortSingleQueueQEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RemoteTaskCommunicationConfigurationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RemoteTaskCommunicationConfigurationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RemoteTaskCommunicationConfigurationLabelFigure() {
			this.setText("RemoteTaskCommunicationConfiguration");
		}
