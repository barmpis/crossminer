 ...
 * @generated
 */
public class DataFilteringTempEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataFilteringTempEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.DataFiltering_2008, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.DataFilteringTempEditPart.VISUAL_ID));
		}
		return parser;
	}
