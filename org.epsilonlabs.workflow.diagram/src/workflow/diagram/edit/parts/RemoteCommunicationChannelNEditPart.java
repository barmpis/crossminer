 ...
 * @generated
 */
public class RemoteCommunicationChannelNEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RemoteCommunicationChannelNEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.RemoteCommunicationChannel_2020,
					getParserElement(), WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.RemoteCommunicationChannelNEditPart.VISUAL_ID));
		}
		return parser;
	}
