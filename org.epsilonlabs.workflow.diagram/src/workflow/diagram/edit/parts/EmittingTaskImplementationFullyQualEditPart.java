 ...
 * @generated
 */
public class EmittingTaskImplementationFullyQualEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmittingTaskImplementationFullyQualEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.EmittingTask_2011, getParserElement(),
					WorkflowVisualIDRegistry.getType(
							workflow.diagram.edit.parts.EmittingTaskImplementationFullyQualEditPart.VISUAL_ID));
		}
		return parser;
	}
