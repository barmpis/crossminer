 ...
 * @generated
 */
public class FilesRepoPatternsEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FilesRepoPatternsEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Files_2006, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.FilesRepoPatternsEditPart.VISUAL_ID));
		}
		return parser;
	}
