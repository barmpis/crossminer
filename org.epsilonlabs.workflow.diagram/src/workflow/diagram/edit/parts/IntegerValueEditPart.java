 ...
 * @generated
 */
public class IntegerValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IntegerValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Integer_2013, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.IntegerValueEditPart.VISUAL_ID));
		}
		return parser;
	}
