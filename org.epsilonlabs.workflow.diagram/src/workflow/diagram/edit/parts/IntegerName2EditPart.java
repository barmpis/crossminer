 ...
 * @generated
 */
public class IntegerName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IntegerName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Integer_3002, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.IntegerName2EditPart.VISUAL_ID));
		}
		return parser;
	}
