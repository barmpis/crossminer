 ...
 * @generated
 */
public class BooleanName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BooleanName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Boolean_3003, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.BooleanName2EditPart.VISUAL_ID));
		}
		return parser;
	}
