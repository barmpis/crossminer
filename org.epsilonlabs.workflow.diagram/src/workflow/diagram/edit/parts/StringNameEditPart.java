 ...
 * @generated
 */
public class StringNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StringNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.String_2012, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.StringNameEditPart.VISUAL_ID));
		}
		return parser;
	}
