 ...
 * @generated
 */
public class EmittingTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EmittingTaskNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.EmittingTask_2011, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.EmittingTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
