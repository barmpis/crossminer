...
public class ScriptedTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.ScriptedTask_2018, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.ScriptedTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
