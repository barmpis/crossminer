 ...
 * @generated
 */
public class StringName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StringName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.String_3001, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.StringName2EditPart.VISUAL_ID));
		}
		return parser;
	}
