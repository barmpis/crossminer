 ...
 * @generated
 */
public class DataAggregationTempEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataAggregationTempEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.DataAggregation_2007, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.DataAggregationTempEditPart.VISUAL_ID));
		}
		return parser;
	}
