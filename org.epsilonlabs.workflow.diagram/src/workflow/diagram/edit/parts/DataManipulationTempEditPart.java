 ...
 * @generated
 */
public class DataManipulationTempEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataManipulationTempEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.DataManipulation_2010, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.DataManipulationTempEditPart.VISUAL_ID));
		}
		return parser;
	}
