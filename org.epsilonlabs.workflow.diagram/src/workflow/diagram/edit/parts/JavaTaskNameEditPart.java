 ...
 * @generated
 */
public class JavaTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public JavaTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.JavaTask_2017, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.JavaTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
