 ...
 * @generated
 */
public class CommunicationChannelNEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CommunicationChannelNEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.CommunicationChannel_2021,
					getParserElement(), WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.CommunicationChannelNEditPart.VISUAL_ID));
		}
		return parser;
	}
