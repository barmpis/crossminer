 ...
 * @generated
 */
public class BooleanValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BooleanValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Boolean_2014, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.BooleanValueEditPart.VISUAL_ID));
		}
		return parser;
	}
