 ...
 * @generated
 */
public class GithubUrlEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GithubUrlEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Github_2001, getParserElement(),
					WorkflowVisualIDRegistry.getType(workflow.diagram.edit.parts.GithubUrlEditPart.VISUAL_ID));
		}
		return parser;
	}
