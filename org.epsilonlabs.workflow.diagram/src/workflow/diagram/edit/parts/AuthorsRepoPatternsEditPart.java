 ...
 * @generated
 */
public class AuthorsRepoPatternsEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AuthorsRepoPatternsEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkflowParserProvider.getParser(WorkflowElementTypes.Authors_2005, getParserElement(),
					WorkflowVisualIDRegistry
							.getType(workflow.diagram.edit.parts.AuthorsRepoPatternsEditPart.VISUAL_ID));
		}
		return parser;
	}
