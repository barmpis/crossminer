package org.eclipse.crossmeter.workflow.execution.sandbox.kafka;
...
public class KafkaTest {
	...
	public static void main(String[] args) throws Exception {
		...
		//kafka server ip (any if in cluster)
		...
		//running kafka after configuring streams and functions...
		KafkaStreams streams = new KafkaStreams(builder, props);

		// This is for reset to work. Don't use in production - it causes the
		// app to re-load the state from Kafka on every start
		streams.cleanUp();
